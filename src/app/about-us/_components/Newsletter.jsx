    ...
    <div className="py-20 bg-brandDark overflow-hidden text-white">
      <div className="lg:w-3/5 w-full px-4 mx-auto text-center flex flex-col items-center justify-center">
        ...
        <div className="lg:w-3/5 bg-white py-2 px-5 rounded-2xl my-5">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex justify-between space-x-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Enter your email address"className="border-0" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <Button className="bg-brandPrimary px-5 rounded-2xl" type="submit">Get Started</Button>
            </form>
          </Form>
        </div>
      </div>
