...
const PaymentOptions = () => {
  return (
    <div className="h-[500px] lg:h-[400px] relative">
      ...
      <div className="absolute w-4/5 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white px-10 py-5 shadow-lg rounded-2xl">
        <div className="text-center">
          <h1 className="font-bold text-2xl lg:text-4xl l leading-tight ">Flexible payment options</h1>
          ...
          <div className="flex flex-col items-center">
            ...
            <div class="flex justify-center -space-x-3">
              ...
              <img
                ...
                alt="Image Description"
              />
              <span class="inline-flex items-center justify-center h-10 w-10 rounded-full ring-2 ring-white bg-gray-800 dark:bg-gray-900 dark:ring-gray-800">
                <span class="text-xs font-medium leading-none text-white uppercase">2k+</span>
              </span>
            </div>
